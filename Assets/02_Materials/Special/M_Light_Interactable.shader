...
Shader "M_Light_Interactable"
{
	Properties
	{
		...
		_EMISSIVE_color("EMISSIVE_color", Color) = (1,1,1,0)
		_EMISSIVE_intensity("EMISSIVE_intensity", Float) = 1
		[Toggle(_PANNING_OR_NOT_ON)] _PANNING_or_Not("PANNING_or_Not?", Float) = 1
		_PANNING_texture("PANNING_texture", 2D) = "white" {}
		_PANNING_tile("PANNING_tile", Float) = 1
		_PANNING_speed_Y("PANNING_speed_Y", Float) = 1
		[Toggle(_FLICKING_OR_NOT_ON)] _FLICKING_or_Not("FLICKING_or_Not?", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _FLICKING_OR_NOT_ON
		#pragma shader_feature_local _PANNING_OR_NOT_ON
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#ifdef _PANNING_OR_NOT_ON
				float4 staticSwitch19 = tex2D( _PANNING_texture, panner9 );
			#else
				float4 staticSwitch19 = temp_cast_1;
			#endif
			float4 temp_output_13_0 = ( _EMISSIVE_color * staticSwitch19 );
			float clampResult20 = clamp( (sin( ( _Time.w * _FLICKING_speed ) )*_FLICKING_attenuation + _FLICKING_attenuation) , -1.0 , 1.0 );
			#ifdef _FLICKING_OR_NOT_ON
				float4 staticSwitch37 = ( temp_output_13_0 * clampResult20 );
			#else
				float4 staticSwitch37 = temp_output_13_0;
			#endif
...
/*ASEBEGIN
Version=17600
-1366;326;1366;707;3289.056;146.4097;1.239605;True;True
Node;AmplifyShaderEditor.RangedFloatNode;11;-2355.487,356.8029;Inherit;False;Property;_PANNING_speed_Y;PANNING_speed_Y;6;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-2108.952,744.2701;Inherit;False;Property;_FLICKING_speed;FLICKING_speed;9;0;Create;True;0;0;False;0;8;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-1697.923,727.4808;Inherit;False;Property;_FLICKING_attenuation;FLICKING_attenuation;8;0;Create;True;0;0;False;0;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;14;-1734.289,113.1567;Inherit;True;Property;_PANNING_texture;PANNING_texture;4;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;5;-1158.625,257.6933;Inherit;False;Property;_EMISSIVE_color;EMISSIVE_color;1;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;19;-1307.651,88.74939;Inherit;False;Property;_PANNING_or_Not;PANNING_or_Not?;3;0;Create;True;0;0;False;0;0;1;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-611.6451,612.2311;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;37;-413.8521,66.80206;Inherit;False;Property;_FLICKING_or_Not;FLICKING_or_Not?;7;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-323.2093,289.6902;Inherit;False;Property;_EMISSIVE_intensity;EMISSIVE_intensity;2;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EB2C05E80467F7635DC6847EB0F11FAA850CEBB8